                    ...
                    <div className='project-links d-flex flex-row'>
                        {
                            ...
                            (
                                project.githubLinks.map((item, index) => {
                                    return <a key={index} className='hover-underline-animation' href={item.link} target='_blank' rel='noreferrer'>{item.label || 'View Code'}&nbsp;<FontAwesomeIcon icon={faGithub} /></a>
                                }) 
                            )
                        }
                        {
                            ...
                            (
                                project.liveLinks.map((item, index) => {
                                    return <a key={index} className='hover-underline-animation' href={item.link} target='_blank' rel='noreferrer'>{item.label || 'View Live'}&nbsp;<FontAwesomeIcon icon={faLink} /></a>
                                }) 
                            )
                        }
                    </div>
