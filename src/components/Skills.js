...
import { faAngular, faBootstrap, faCss3, faDocker, faEmber, faHtml5, faJs, faPython, faReact } from '@fortawesome/free-brands-svg-icons';
import { faAntdesignIcon, faJqueryIcon, faMysqlIcon, faNextjsIcon, faPostgresqlIcon, faRubyIcon, faRubyOnRailsIcon, faSqlIcon } from './../custom_icons';
